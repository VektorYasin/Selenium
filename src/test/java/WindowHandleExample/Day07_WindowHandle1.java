...
//        Then user verifies the new window title is “New Window”
        //WE DO TESTTING IN A NEW WINDOW, SO WE MUST SWITCH TO THAT WINDOW
        //AS OF NOW, 2 WINDOWS ARE OPEN, USE setWindowHandles() to GET BOTH IDs
        Set<String> allWindowHandles= driver.getWindowHandles();
        System.out.println(allWindowHandles);
        //Set, içinde duplikasyon olmayan veri seti

        for(String eachHandle : allWindowHandles){//looping through windows
